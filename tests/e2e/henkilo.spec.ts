...
test.describe('Valintalaskenta', () => {
  ...
  test('succesfully starts laskenta and shows yhteenveto errors', async ({
    ...
    await expect(
      page.getByText(
        'Tampereen yliopisto, Rakennetun ympäristön tiedekunta \u2013 Finnish MAOL competition route, Technology, Sustainable Urban Development, Bachelor and Master of Science (Technology) (3 + 2 yrs) (1.2.246.562.20.00000000000000045105)',
      ),
    ).toBeVisible();
