...
// Huom: Tässä tiedostossa ei saa viitata import.meta.env:iin, koska
// Playwright-testit importtaavat tämän ja Playwrightin TS-kääntäjä ei tue sitä.
// Ympäristökohtainen domain välitetään parametrina (ks. load-configuration.ts).
export function buildConfiguration({
  domain = 'https://localhost:3404',
  loginUrl,
  sessionCookie,
  ...
  return {
    ...
    routes: {
      yleiset: {
        ...
        loginUrl: loginUrl ?? `${domain}/cas/login`,
        sessionCookie: sessionCookie ?? 'JSESSIONID',
      ...
      valintalaskentakoostepalvelu: {
        ...
        importValinnanTulosUrl: `${domain}/valintalaskentakoostepalvelu/resources/erillishaku/tuonti`,
